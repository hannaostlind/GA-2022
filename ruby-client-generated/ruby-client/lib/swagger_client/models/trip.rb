...
module SwaggerClient
  class Trip
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Leg')
        if (value = attributes[:'Leg']).is_a?(Array)
          self.leg = value
        end
      end

      if attributes.has_key?(:'travelWarranty')
        self.travel_warranty = attributes[:'travelWarranty']
      end
    ...
    def list_invalid_properties
      ...
      if @alternative.nil?
        invalid_properties.push('invalid value for "alternative", alternative cannot be nil.')
      end
    ...
    def valid?
      return false if @alternative.nil?
      type_validator = EnumAttributeValidator.new('String', ['WALK', 'BIKE', 'CAR'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['WALK', 'BIKE', 'CAR'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          leg == o.leg &&
          travel_warranty == o.travel_warranty &&
          valid == o.valid &&
    ...
    def hash
      [leg, travel_warranty, valid, alternative, type].hash
    end
