...
module SwaggerClient
  class Departure
    ...
    def hash
      [fg_color, stop, booking, direction, journey_detail_ref, track, rt_track, sname, type, date, bg_color, stroke, rt_date, time, name, rt_time, night, stopid, journeyid, accessibility].hash
    end
