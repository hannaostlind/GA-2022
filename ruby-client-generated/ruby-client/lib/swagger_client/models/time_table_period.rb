...
module SwaggerClient
  class TimeTablePeriod
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'DateBegin')
        self.date_begin = attributes[:'DateBegin']
      end
    ...
    def list_invalid_properties
      ...
      if @date_begin.nil?
        invalid_properties.push('invalid value for "date_begin", date_begin cannot be nil.')
      end
    ...
    def valid?
      return false if @date_begin.nil?
