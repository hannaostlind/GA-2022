...
# Unit tests for SwaggerClient::DepartureBoardApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DepartureBoardApi' do
  before do
    # run before each test
    @instance = SwaggerClient::DepartureBoardApi.new
  end
  ...
  describe 'test an instance of DepartureBoardApi' do
    it 'should create an instance of DepartureBoardApi' do
      expect(@instance).to be_instance_of(SwaggerClient::DepartureBoardApi)
    end
  end

  # unit tests for get_departure_board
  ...
  describe 'get_departure_board test' do
    it 'should work' do
